...
export HBASE_MASTER_OPTS="$HBASE_MASTER_OPTS $HBASE_JMX_BASE -Dcom.sun.management.jmxremote.port=20101 -javaagent:$HBASE_HOME/jmx/jmx_prometheus_javaagent-0.16.1.jar=27000:$HBASE_HOME/jmx/hbase_jmx_config.yaml"

export HBASE_REGIONSERVER_OPTS="$HBASE_REGIONSERVER_OPTS $HBASE_JMX_BASE -Dcom.sun.management.jmxremote.port=20102 -javaagent:$HBASE_HOME/jmx/jmx_prometheus_javaagent-0.16.1.jar=27001:$HBASE_HOME/jmx/hbase_jmx_config.yaml"

export HBASE_REGIONSERVER_OPTS="$HBASE_REGIONSERVER_OPTS -Xms10240m -Xmx10240m -XX:ParallelGCThreads=24 $JDK_DEPENDED_OPTS -server -Xmn5g  -XX:MaxTenuringThreshold=3  -XX:+CMSScavengeBeforeRemark  -XX:+UseConcMarkSweepGC -XX:+CMSParallelRemarkEnabled -XX:+UseParNewGC -XX:+UseCMSCompactAtFullCollection -XX:CMSFullGCsBeforeCompaction=3 -XX:+UseCMSInitiatingOccupancyOnly -XX:CMSInitiatingOccupancyFraction=60 -XX:MetaspaceSize=512m"
